...
# cap = cv2.VideoCapture("data/img/5.mp4")
...
bt = Button(root,text="Quit", font=("times",15),fg="blue",width=30, command=quit)
# bt.grid(column=1, row=1)
bt.place(x=50, y= 150)
bt1 = Button(root, text="Video", font=("times",15),fg="blue", width=30, command=web)
# bt1.grid(column=1,row=2)
bt1.place(x=50, y= 0)
bt2 = Button(root,text="Image",font=("times",15),fg="blue", width=30, command=image)
# bt2.grid(column=1,row=3)
bt2.place(x=50, y= 50)
bt3 = Button(root,text="Camera",font=("times",15),fg="blue", width=30, command=camera)
